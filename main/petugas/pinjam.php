...
$result = mysqli_query($conn, "SELECT * FROM buku WHERE id_buku='$kodebuku'");
...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['nis'] == null || $_POST['total'] == null) {
        ...
        $sendd = mysqli_query($conn, "INSERT INTO `peminjaman` (`id_peminjaman`, `id_siswa`, `id_petugas`, `tanggal_peminjaman`, `tanggal_pengembalian`) VALUES (NULL, '$nis', '$petugas', '$tgl', '$tgl7'); ");
        $dataid = mysqli_query($conn, "SELECT id_peminjaman FROM peminjaman ORDER BY id_peminjaman DESC limit 1");
        $id_peminjaman = '';
        if ($sendd) {
            # code...
            ...
            echo $id_peminjaman;
            if ($sendd) {
                $sendd2 = mysqli_query($conn, "INSERT INTO `detail_peminjaman` (`id_detail_peminjaman`, `id_buku`, `id_peminjaman`, `kuantitas`) VALUES (NULL, '$kodebuku', '$id_peminjaman', '$total');");
...
<div class="mb-3">
    <input readonly type="text" value="<?php echo $kodebuku; ?>" name="kodebuku" class="input" placeholder="NIP" aria-label="Email" aria-describedby="email-addon">
</div>
<label>Judul</label>
<div class="mb-3">
...
<label>NIS</label>
<select name="nis" class="input" aria-label="Default select example">
...
<label>Total</label>
<div class="mb-3">
    <input type="number" name="total" class="input" placeholder="Total" aria-label="Email" aria-describedby="email-addon">
</div>
