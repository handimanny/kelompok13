...
{	
    ...
    $result = mysqli_query($conn, "UPDATE kelas SET id_kelas='$id_kelas', nama_kelas='$nama_kelas' WHERE id_kelas=$id_kelas");
...
<div class="mb-3">
<label class="form-lable">Id Kelas</label>
<input type="text" class="input" name="id_kelas" value=<?php echo $id_kelas;?>>
</div>
<div class="mb-3">
<label class="form-lable">Nama Kelas</label>
<input type="text" class="input" name="nama_kelas" value=<?php echo $nama_kelas;?>>
</div>
<br>
<div class="mb-3">
