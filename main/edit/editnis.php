...
{	
    ...
    $result = mysqli_query($conn, "UPDATE siswa SET nis='$nis', nama='$nama', jenis_kelamin='$jenis_kelamin', alamat='$alamat', id_kelas='$id_kelas' WHERE nis=$nis");
...
<div class="mb-3">
    ...
    <select class="input" name="id_kelas" value=<?php echo $id_kelas;?>>
